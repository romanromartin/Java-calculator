...
public class Main {
    ...
    public static String calc(String input) throws Exception {
        String str = input.replaceAll (" ", "").toUpperCase();
        ...
        for( char c : op){
            if(str.contains(String.valueOf(c))){
                ...
                if (isNumeric(a) && isNumeric(b) ){
                    ...
                    else throw  new Exception( "одно из чисел вне диапазона");
                }
                    ...
                    if (result<1) throw  new Exception( "в римской системе нет отрицательных чисел и 0");
                    else {
                        int temp;
                        int count_rom = 0;
